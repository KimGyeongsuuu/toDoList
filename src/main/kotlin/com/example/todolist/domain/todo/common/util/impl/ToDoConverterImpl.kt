...
class ToDoConverterImpl(
    ...
    override fun toDetailToDoDto(toDo: ToDo, member: Member): DetailToDoDto =
        DetailToDoDto(
            title = toDo.title,
            content = toDo.content,
            writer = toDo.member,
    ...
    override fun toDetailToDoResponse(detailToDoDto: DetailToDoDto, member: Member): DetailToDoResponse =
        DetailToDoResponse(
            title = detailToDoDto.title,
            content = detailToDoDto.content,
            writer = memberConverter.toMemberResponse(detailToDoDto.writer),
            date = detailToDoDto.date
        )
